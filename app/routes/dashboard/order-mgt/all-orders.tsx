...
import IconOne from "~/assets/icons/IconOne";
import IconTwo from "~/assets/icons/IconTwo";
import IconThree from "~/assets/icons/IconThree";
import IconFour from "~/assets/icons/IconFour";
...
const metricsData = [
  {
    label: "Today Sales",
    value: "34,560",
    icon: IconOne, // replace with actual icon component or path
    bgColor: "#4BCC0026", // light green bg
  },
  {
    label: "This Week's Sales",
    value: "34,560",
    icon: IconTwo, // same green icon
    bgColor: "#39C27226",
  },
  {
    label: "Last Month's Sales",
    value: "34,560",
    icon: IconThree, // orange icon
    bgColor: "#E07B3926",
  },
  {
    label: "Last 3 Month's Sales",
    value: "34,560",
    icon: IconFour, // green icon again
    bgColor: "#03660026",
  },
];
...
export default function AllOrders() {
  ...
  return (
    <div className="px-2  space-y-5">
      ...
      {/* </span> */}
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 lg:gap-3 xl:gap-4 gap-2 mt-6">
        {metricsData?.map((_, index) => (
          ...
          >
            ...
            <div
              ...
              style={{backgroundColor: _?.bgColor}}
            >
              <_.icon className="w-[17px] md:w-[30px] lg:w-[40px]" />
            </div>
            {/* </div> */}
            <div className="flex flex-col lg:gap-y-3 md:gap-y-2 ">
                      ...
                      <Dialog open={open} onOpenChange={setOpen}>
                        ...
                        <DialogContent className="max-w-md bg-[#FFFFFF] rounded-[16px] [&>button]:hidden p-0 m-0 w-[90%] lg:w-auto">
                          ...
                          <div className="space-y-3 pt-2 lg:px-[30px] px-[14px]">
                            <div className="flex flex-col gap-y-2">
                              <span className=" flex flex-row justify-between gap-x-2">
                                <AppText
                                  ...
                                  weight="light"
                                  color="#1A1A1A"
                                  className="text-xs md:text-base lg:text-[18px]"
                                  align="left"
                                >
                                  Order ID
                                </AppText>
                                <AppText
                                  ...
                                  weight="semibold"
                                  color="#1A1A1A"
                                  className="text-xs md:text-base lg:text-[18px] grow min-w-[50%] max-w-[65%]"
                                  align="left"
                                >
                                  #VD98012
                                </AppText>
                            ...
                            <Textarea
                              placeholder="Reason for refund goes here"
                              className="w-full h-[126px] border border-[#114A45] rounded-[8px] text-[13px] p-3 focus:outline-0 focus:shadow-none bg-[#F3F4F7] mt-5 text-[#545454]"
                            />
                          </div>
